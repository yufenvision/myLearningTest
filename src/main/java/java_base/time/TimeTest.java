...
//		Long java_base.time = System.currentTimeMillis();
//		Date date = new Date(java_base.time);
//		SimpleDateFormat sm = new SimpleDateFormat("yyyyMM/dd HH:mm:ss");
//		String timeStr = sm.format(date)+"-"+java_base.time.toString().length();
//		System.out.println(timeStr);
//		System.out.println(java_base.time.toString());
