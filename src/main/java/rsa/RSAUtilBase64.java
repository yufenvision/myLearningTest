...
public class RSAUtilBase64 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println(decrypt(pswFromWeb, privateKetStr));

        //根据IOS端提供的公钥，私钥来解密
        System.out.println("IOS端==========================================================================");
        String basePath = System.getProperty("user.dir");
        String publicKeyPath = basePath + "/src/main/java/rsa/rsa_public_key.pem";        // replace your public key path here
