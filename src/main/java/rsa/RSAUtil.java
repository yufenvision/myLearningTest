...
public class RSAUtil {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String publicKeyPath = basePath + "/main/java/rsa/rsa_public_key.pem";        // replace your public key path here
        String privateKeyPath = basePath + "/main/java/rsa/pkcs8_private_key.pem";     // replace your private path here
